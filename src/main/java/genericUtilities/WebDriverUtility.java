...
{	
	...
	/**
	 * This element will wait until a particular element becomes visible
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * This method will wait until page loaded & returns true if title match, else return false
	 * @param driver
	 * @param title
	 */
	...
	/**
	 * This method will handle dropdown by using text
	 * @param text
	 * @param element
	 */
	...
	/**
	 * This method will handle mouseHover action on specified elment
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * This method will perform double click action on specified element
	 * @param element
	 * @param driver
	 */
	...
	/**
	 * This method will perform right click action anywhere on page
	 * @param driver
	 */
	...
	/**
	 * This method will perform right click action on specified element
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * This method will handle drag and drop action on specified webelements
	 * @param driver
	 * @param srcElement
	 * @param dstElement
	 */
	...
	/**
	 * This method will switch to frame based on frameId or frame name
	 * @param driver
	 * @param frameIDorName
	 */
	...
	/**
	 * This method will switch back to the default frame
	 * @param driver
	 */
	...
	/**
	 * This method will get the text of alert pop up and return it to caller method
	 * @param driver
	 * @return
	 */
	...
	{	
		...
		//Step 2: Extract individual window Id's
	...
	public String takeScreenShot(WebDriver driver,String ScreenShotName) throws IOException
	{
		...
		FileUtils.copyFile(src, dst); //this is from commons io dependency
	...
	/**
	 * This method scroll downward randomly
	 * @param driver
	 */
	...
	/**
	 * This method will scroll downward until the specific element
	 * @param driver
	 * @param element
	 */
